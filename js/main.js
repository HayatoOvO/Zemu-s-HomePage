...
$("#github").mouseover(function () {
    $("#link-text").html("去我的 GitHub 看看");
}).mouseout(function () {
    $("#link-text").html("或许我......在这里");
});
$("#qq").mouseover(function () {
    $("#link-text").html("哦？QQ可不兴找啊");
}).mouseout(function () {
    $("#link-text").html("或许我......在这里");
});
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change1").html("The Special Space for me.");
    }
});
...
color: rgb(0,255,0);
`
var title1 = 'Zemu Song'
var title2 = 'Powered by Shiroiame Kusu'
var title3 = 'Modified by Zemu'
var content = `
...
修改者：Zemu Song
主页：https://zemu.im
GitHub:  https://github.com/HayatoOvO
邮箱：i@zemu.im

`

var content0 = `
从原作开始，此项目 Based on https://github.com/imsyy/home
...
%c${content} %c${content0}`, styleTitle1, styleTitle2, styleTitle3, styleContent, styleContent0)